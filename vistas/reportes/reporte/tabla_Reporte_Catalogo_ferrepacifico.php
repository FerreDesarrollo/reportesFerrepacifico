...
<table class="display nowrap table table-sm table-bordered table-hover table-responsive-sm" style="text-align: center; width:100%" id="resultsTable" >
	...
	<tr style="width:33%" role="row">
        ...
        <th > <span>minimo</span></th>
        <th > <span>maximo</span></th>
...
$dias_del_mes=  $_GET['dias_del_mes'] ;
        ...
        for ($i = 0; $i < count($obj); $i++) { 
            ...
            for ($ii = 0; $ii < count($clientes1); $ii++) {
                ...
                if ($venta != 0 && $dias_transcurridos != 0) {
                    $dias1 = $stock_ps / ($venta / $dias_transcurridos);
                } else {
                    // Maneja el caso donde la división no es válida, por ejemplo:
                    $dias1 = 0; // O algún otro valor que tenga sentido para tu lógica.
    ...
    ?>
                <tr>
                    ...
                    <td style="text-align:left"><?php echo number_format($dias1, 2); ?></td>
                    ...
                    <td style="text-align:left"><?php echo $clientes1[$ii]->{'minimo'}; ?></td>
                    
                    <td style="text-align:left"><?php echo $clientes1[$ii]->{'maximo'}; ?></td>
                </tr>
    <?php   
            }
        }
