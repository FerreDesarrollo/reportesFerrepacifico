...
$obj = clientes([ "consulta" => "descontinuados_marca","f_ini" => date('d/m/Y',strtotime($_GET['fechainicial'])),"f_fin" => date('d/m/Y',strtotime($_GET['fechafinal'])),"sucursal"=>$sucursal1,"marca"=>$marca]);
$obj=json_decode($obj);
?>
<style>
    .tablas{
...
<table class="display nowrap table table-sm table-bordered table-hover table-responsive-sm" style="text-align: center; width:100%" id="resultsTable" >
	...
	<tbody >
		...
		?>
            ...
            <td style="text-align:left"><?php echo $clientes1[$ii]->{'marca'}; ?></td>
