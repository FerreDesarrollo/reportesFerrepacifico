...
$obj = clientes([ "consulta" => "toplow","f_ini" => date('d/m/Y',strtotime($_GET['fechainicial'])),"f_fin" => date('d/m/Y',strtotime($_GET['fechafinal'])),"vendedor" => $vendedor,"sucursal"=>$sucursal]);
$obj=json_decode($obj);
$obj1 = clientes([ "consulta" => "toplows","f_ini" => date('d/m/Y',strtotime($_GET['fechainicial'])),"f_fin" => date('d/m/Y',strtotime($_GET['fechafinal'])),"vendedor" => $vendedor,"sucursal"=>$sucursal]);
...
<center><table class="display nowrap table table-sm table-bordered table-hover table-responsive-sm">
    <tr><th>Stock Disponible</th><th>Valor de Stock</th></tr>
    <tr><td style="text-align:right"><?php echo number_format($obj[0][0]->{'stock_disponible'},0)?></td><td style="text-align:right"><?php echo "$".number_format($obj[0][0]->{'valor_de_stock'},2)?></td></tr>
</table></center>
<br>
