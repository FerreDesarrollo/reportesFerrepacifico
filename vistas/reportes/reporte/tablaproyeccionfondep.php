...
$obj = clientes([ "consulta" => "proyeccion_fonde","f_ini" => date('d/m/Y',strtotime($_GET['fechainicial'])),"f_fin" => date('d/m/Y',strtotime($_GET['fechafinal'])),"vendedor" => $vendedor,"sucursal"=>$sucursal]);
$obj=json_decode($obj);
?>
<style>
    .tablas{
		...
		<?php 
            for ($i=0; $i < count($obj); $i++) { 
                ...
                for ($ii=0; $ii < count($clientes1); $ii++) {
                    ...
                    $porcentaje=number_format(($clientes1[$ii]->{'venta_real'}/(($clientes1[$ii]->{'venta'}/count($diastotal))*count($diastranscurridos)))*100,2);
                    ...
                    $venta_dia=((($clientes1[$ii]->{'venta'}/count($diastotal))*count($diastranscurridos)));
					$utilidas_dia=((($clientes1[$ii]->{'utilidad'}/count($diastotal))*count($diastranscurridos)));
		?>
                <tr>
                    <td style="text-align:left" ><?php echo $clientes1[$ii]->{'sucursal'}; ?></td>
                    <td style="text-align:left" class="precio"><?php echo $clientes1[$ii]->{'venta'}; ?></td>
                   
                    <td style="text-align:left" class="precio"><?php echo $venta_dia ?></td>
                    <td style="text-align:left" class="precio" ><?php echo $clientes1[$ii]->{'venta_real'}; ?></td>
                    <td style="text-align:right;background-color:<?php echo $color ?>"><?php echo $porcentaje."%" ?></td>
                    <td style="text-align:left" class="precio"><?php echo $clientes1[$ii]->{'utilidad'}; ?></td>
                    

                    <td style="text-align:left"class="precio"><?php echo $utilidas_dia ?></td>
                    <td style="text-align:left" class="precio"><?php echo $clientes1[$ii]->{'utilidad_real'}; ?></td>
                    <td style="text-align:right;background-color:<?php echo $color2 ?>"><?php echo $porcentaje2."%" ?></td>
                    <td style="text-align:left"class="precio"><?php echo $clientes1[$ii]->{'margen_objetivo'}; ?></td>
                    <td style="text-align:left"class="precio"><?php echo $clientes1[$ii]->{'margen_real'}; ?></td>
