...
// Verifica si el parámetro 'parametro1' ha sido enviado
 ...
 $tipo_Filtro="";
	...
	$obj = clientes([ "consulta" =>"filtro_solucion"]);
	$obj=json_decode($obj);
	for ($i=0; $i < count($obj); $i++) { 
		...
		for ($ii=0; $ii < count($clientes1); $ii++) { 
			...
			if(isset($clientes1[$ii]->{'id'})){
				$id=$clientes1[$ii]->{'id'};
				$nombre=$clientes1[$ii]->{'name'};
				//$nombre = $db->caracters($nombre);
				array_push($c,"".$id." - ".$nombre."");
			}
	...
	print_r(json_encode($c));
    ...
    else    if($parametro1=='group'){
          
        $obj = clientes([ "consulta" =>"filtro_grupo"]);
        $obj=json_decode($obj);
        for ($i=0; $i < count($obj); $i++) { 
            $clientes1=$obj[$i];
            for ($ii=0; $ii < count($clientes1); $ii++) { 
        ...
        print_r(json_encode($c));
             ...
             else    if($parametro1=='filtro_linea'){
          
                $obj = clientes([ "consulta" =>"filtro_linea"]);
                $obj=json_decode($obj);
                for ($i=0; $i < count($obj); $i++) { 
                    $clientes1=$obj[$i];
                    for ($ii=0; $ii < count($clientes1); $ii++) { 
                ...
                print_r(json_encode($c));
                     ...
                     else    if($parametro1=='filtro_sublinea'){
          
                        $obj = clientes([ "consulta" =>"filtro_sublinea"]);
                        $obj=json_decode($obj);
                        for ($i=0; $i < count($obj); $i++) { 
                            $clientes1=$obj[$i];
                            for ($ii=0; $ii < count($clientes1); $ii++) { 
                        ...
                        print_r(json_encode($c));
                             ...
                             else    if($parametro1=='filtro_proveedorinc'){
          
                                $obj = clientes([ "consulta" =>"filtro_proveedorinc"]);
                                $obj=json_decode($obj);
                                for ($i=0; $i < count($obj); $i++) { 
                                    $clientes1=$obj[$i];
                                    for ($ii=0; $ii < count($clientes1); $ii++) { 
                                ...
                                print_r(json_encode($c));
                                     ...
                                     else    if($parametro1=='filtro_proveedorac'){
          
                                        $obj = clientes([ "consulta" =>"filtro_proveedorac"]);
                                        $obj=json_decode($obj);
                                        for ($i=0; $i < count($obj); $i++) { 
                                            $clientes1=$obj[$i];
                                            for ($ii=0; $ii < count($clientes1); $ii++) { 
                                        ...
                                        print_r(json_encode($c));
                                             ...
                                             else    if($parametro1=='filtro_proveedor'){
          
                                                $obj = clientes([ "consulta" =>"filtro_proveedor"]);
                                                $obj=json_decode($obj);
                                                for ($i=0; $i < count($obj); $i++) { 
                                                    $clientes1=$obj[$i];
                                                    for ($ii=0; $ii < count($clientes1); $ii++) { 
                                                ...
                                                print_r(json_encode($c));
                                                     ...
                                                     else    if($parametro1=='filtro_marca'){
          
                                                        $obj = clientes([ "consulta" =>"filtro_marca"]);
                                                        $obj=json_decode($obj);
                                                        for ($i=0; $i < count($obj); $i++) { 
                                                            $clientes1=$obj[$i];
                                                            for ($ii=0; $ii < count($clientes1); $ii++) { 
                                                        ...
                                                        print_r(json_encode($c));
                                                             ...
                                                             else    if($parametro1=='filtro_comprador'){
          
                                                                $obj = clientes([ "consulta" =>"filtro_comprador"]);
                                                                $obj=json_decode($obj);
                                                                for ($i=0; $i < count($obj); $i++) { 
                                                                    $clientes1=$obj[$i];
                                                                    for ($ii=0; $ii < count($clientes1); $ii++) { 
