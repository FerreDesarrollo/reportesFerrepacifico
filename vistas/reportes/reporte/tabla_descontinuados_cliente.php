...
$obj = clientes([ "consulta" => "descontinuados_cliente","f_ini" => date('d/m/Y',strtotime($_GET['fechainicial'])),"f_fin" => date('d/m/Y',strtotime($_GET['fechafinal'])),"sucursal"=>$sucursal1,"marca"=>$marca]);
$obj=json_decode($obj);
?>
<style>
    .tablas{
