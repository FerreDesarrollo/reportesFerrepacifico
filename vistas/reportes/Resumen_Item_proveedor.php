...
<div class="container">
    ...
    <h4 style="text-align:center"><strong>Resumen de Items por Proveedor</strong></h4>
  ...
  <option value="23">Mayoreo</option>
		...
		<div class="col-md-6">     
            <div class="p-1 flex-fill bd-highlight">
                <input type="submit" class="btn btn-info" name="Resumen" id="Resumen" value="ver resumen" >
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
	...
	function obtenerTrimestreAnterior(fecha) {
		...
		function btnMinformacion(){
				...
				$.get("reportes/reporte/tabla_Resumen_Item_proveedor.php"
				,
				{
					sucursal:sucursal
