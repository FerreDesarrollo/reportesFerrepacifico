...
<div class="row" >
	...
	<h4 style="text-align:center"><strong>REPORTE DE PROYECCIÓN DE VENTA (Fondeport Proyectos)</strong></h4>
...
<script type="text/javascript">
		function btnMinformacion(){
			...
			var fechaSeleccionada = $('#fechaini').val();

// Compara si la fecha seleccionada es el 1 de octubre de 2024
var fechainicial='';
if (fechaSeleccionada === '2024-10-01') {
     fechainicial = '2024-10-02'; // Asigna el 2 de octubre de 2024
} else {
     fechainicial = fechaSeleccionada; // Deja el valor seleccionado
}
console.log(fechainicial);
			...
			if (f1[1]!=f2[1]) {
				...
				$.get("reportes/reporte/tablaproyeccionfondep.php",{fechainicial:fechainicial,fechafinal:fechafinal,vendedor:nombre,sucursal:sucursal,puesto:puesto},function(htmlexterno){$("#mostrartabla").html(htmlexterno);});
				delay();
				console.log(fechainicial)
